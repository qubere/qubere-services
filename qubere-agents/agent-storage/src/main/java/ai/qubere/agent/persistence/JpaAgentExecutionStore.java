...
public class JpaAgentExecutionStore implements AgentExecutionStore {
    ...
    public void markStarted(AgentExecutionContext context, AgentDescriptor descriptor, AgentInput input) {
        upsertExecution(context, descriptor, input, AgentRunStatus.RUNNING, null);
    }

    @Override
    @Transactional
    public void markQueued(AgentExecutionContext context, AgentDescriptor descriptor, AgentInput input) {
        upsertExecution(context, descriptor, input, AgentRunStatus.QUEUED, null);
    }
    ...
    private void upsertExecution(AgentExecutionContext context, AgentDescriptor descriptor, AgentInput input, AgentRunStatus status, String errorMessage) {

...
/**
 * Local development or test environments may explicitly opt back into trusting inbound headers
 * even in strict authorization mode by setting {@code trust-inbound-headers=true}. This must be
 * a deliberate configuration choice, never the default.
 */
@SpringBootTest(
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
        properties = {
                "spring.profiles.active=test",
                "spring.datasource.url=jdbc:h2:mem:agentauthwebtrusted;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=false",
...
class AgentAuthorizationTrustedHeaderOptInE2ETest {
    ...
    @Test
    void strictAuthorizationAllowsHeadersWhenTrustIsExplicitlyEnabled() throws Exception {
        String body = """

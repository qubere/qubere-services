...
public class AgentEvaluationInfrastructureAutoConfiguration {
    ...
    GoldenDatasetRepository goldenDatasetRepository(AgentPlatformProperties properties, ResourceLoader resourceLoader) {
        return new ResourceGoldenDatasetRepository(
